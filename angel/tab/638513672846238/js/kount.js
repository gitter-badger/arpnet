    ...
    $.fn.kkcountdown = function(options) {
        ...
        function kkCountDown(oneDay, obj, count){
            ...
            if(dni == 0)
            {
                ...
                if (options.displayZeroDays)
                {
                    obj.find('.kkc-dni').html(dni);
                    obj.find('.kkc-dni-text').html('дни');
                }
                else
                {
                    obj.find('.kkc-dni').html('');
                    obj.find('.kkc-dni-text').html('');
                }
            ...
            if (options.onlyMinutes == 0)
            {
                obj.find('.kkc-godz').html(godziny);
            }
            else if (options.onlyMinutes == 1)
            {
                obj.find('.kkc-godz').html('');
                obj.find('.kkc-godz-text').html('');
            }
