...
var pfennigFont = new Font('pfennigFont', fontFile('OpenSans-Light.ttf'));

pfennigFont.addFace(fontFile('OpenSans-Light.ttf'), 'bold');
pfennigFont.addFace(fontFile('OpenSans-Light.ttf'), 'light');
